...
import { swalNotifSuccess, swalToastError } from 'src/helpers/swalFunction'
...
export const exportReport = createAsyncThunk(
  'appExportReport/exportReport',
  async ({ reportType, month, year }, { rejectWithValue }) => {
    try {
      ...
      if ([ENUM.POS].includes(reportType)) {
        // For POS report, directly return success without file download
        swalNotifSuccess({ message: `Export ${reportType} Berhasil` })
        return { success: true }
      }
