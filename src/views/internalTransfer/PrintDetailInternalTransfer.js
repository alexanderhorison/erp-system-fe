...
const PrintDetailInternalTransfer = ({ id }) => {
  // ** Hooks
  ...
  } else if (errorDetailInternalTransfer) {
    return (
      <Box sx={{ p: 5 }}>
        <Grid container spacing={6}>
          <Grid item xs={12}>
            <Alert severity='error'>
              ...
              <Link href='/internal-transfer/'>Internal Transfer</Link>
            </Alert>
          </Grid>
        </Grid>
      </Box>
...
export default PrintDetailInternalTransfer
