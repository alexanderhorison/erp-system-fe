 ...
 * -------------------------------------------------------------------------------------
 * Read-only detail dialog for a monthly current-asset entry (Figma: "Detail Aset
 * Lancar Bulanan") — a custom shell sharing `AppModal`'s tokens, a period-headed
 * card of key/value rows ending in a bold Grand Total, and Catatan/Dibuat pada
 * side-by-side below it.
 */
export default function ModalViewCurrentAsset({ open, setOpen, selectedRow }) {
