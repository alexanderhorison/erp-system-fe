...
/**
 * ViewDetailProductRequest
 * -------------------------------------------------------------------------------------
 * The product-request document: company letterhead, the requested products,
 * notes, and the creator's signature block.
 *
    ...
    >
          ...
          <Table size='small'>
            <TableHead sx={{ backgroundColor: stone[100] }}>
              <TableRow>
                ...
                <TableCell sx={{ ...sectionLabelSx, borderColor: colors.border }}>Request</TableCell>
              </TableRow>
            </TableHead>
            <TableBody>
      ...
      <CardContent sx={{ p: 5 }}>
        <Box sx={{ display: 'flex', gap: 4, flexWrap: 'wrap' }}>
          <SignatureBlock label='Dibuat Oleh' name={data?.createdBy?.name} timestamp={data?.createdAt} />
        </Box>
      </CardContent>
    </Card>
  )
