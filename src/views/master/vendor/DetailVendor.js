...
export default function DetailVendor({ data, loading }) {
  ...
  return (
    <Grid container spacing={4}>
      ...
      <Grid item xs={12} md={9}>
        <Box sx={cardSx}>
          ...
          <Grid container spacing={4}>
            ...
            <Grid item xs={12} sm={4}>
              <InfoField icon='tabler:user' label='Jenis Kelamin' value={data?.gender} />
            </Grid>
          </Grid>
        </Box>
      </Grid>
      ...
      {openModal && <ModalAddMasterVendor open={openModal} setOpen={setOpenModal} typeModal={'EDIT'} id={data.id} />}
    </Grid>
  )
}
