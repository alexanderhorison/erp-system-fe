...
import TableHeaderMasterShift from './TableHeaderMasterShift'
  ...
  return (
    <Card>
      ...
      <DataGrid
        ...
        columns={[
          ...
          },
          {
            ...
            renderCell: params => {
              ...
              const timeValue = params.row.startShift ? params.row.startShift.substring(0, 5) : ''
              return (
                <Typography variant='body2' sx={{ color: 'text.primary' }}>
                  {timeValue}
                </Typography>
          ...
          },
          {
            ...
            renderCell: params => {
              // Ensure time format is always HH:MM
              const timeValue = params.row.endShift ? params.row.endShift.substring(0, 5) : ''
              return (
                <Typography variant='body2' sx={{ color: 'text.primary' }}>
                  {timeValue}
                </Typography>
        ...
        slots={{ toolbar: TableHeaderMasterShift }}
