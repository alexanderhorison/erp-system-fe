...
export default function TableHeaderMasterCustomer(props) {
  return (
    <Box
      sx={{
        gap: 2,
    ...
    >
      ...
      <Box sx={{ gap: 2, display: 'flex', flexWrap: 'wrap', alignItems: 'center' }}>
        ...
        {/* <Button onClick={() => props.openModalRank(true)} variant='contained' sx={{
          width: '100%',
          '@media (min-width: 600px)': {
            width: 'auto',
          }, '& svg': { mr: 2 }
        }}>
          <Icon fontSize='1.125rem' icon='tabler:arrow-badge-down' />
          Daftar Rank
        </Button> */}
      </Box>
    </Box>
